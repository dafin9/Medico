                    ...
                    >
                        ...
                        <ul className="menu-inner py-1">
                            ...
                            <li className="menu-item active ">
                                ...
                                <ul className="menu-sub active">
                                    <li className="menu-item">
                                        <a href="lab_report.html" className="menu-link">
                            ...
                            <li className="menu-item">
                                ...
                                <ul className="menu-sub">
                                    <li className="menu-item">
                                        <a href="All_report.html" className="menu-link">
                                            <div data-i18n="Without menu">All</div>
                                        </a>
                                    </li>
                                    <li className="menu-item">
                                        <a href="MyHealth_labReport.html" className="menu-link">
                                            <div data-i18n="Without menu">Lab Report</div>
                                        </a>
                                    </li>
                                    <li className="menu-item">
                                        <a href="MyHealth_Prescription.html" className="menu-link">
                                            <div data-i18n="Without navbar">Prescription</div>
                                        </a>
                                    </li>
                                </ul>
